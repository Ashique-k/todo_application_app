...
class DatabaseMethods{
  ...
  Future updateEmployeeDetails( String id,Map<String,dynamic> updateInfo) async{
    ...
    return await FirebaseFirestore.instance.collection("Cleint Details").doc(id).update(updateInfo);
  }
  ...
  Future deleteEmployeeDetails( String id) async{
    ...
    return await FirebaseFirestore.instance.collection("Cleint Details").doc(id).delete();
  }
